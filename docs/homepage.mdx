...
# OpenPages watson<span style={{ color: '#3a60f6' }}>x</span>.ai Translation
**Contacts:**  Eashan Thakuria, John Scott, Samuel Lee <br />
**Team:** FSM CE East <br />

This is a living document for an adoption journey that synthesizes the best practices from IBM when considering and implementing **`OpenPages watsonx.ai Translation`**
