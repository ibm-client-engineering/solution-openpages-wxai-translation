...
This solution doc will address how to implement a translation method for each of the areas mentioned above, as well as outline the necessary requirements for building out each solution component to ultimately demonstrate a successful implementation of a watsonx.ai driven translation service.
...
Content on OpenPages can be fall under one of the two groups:
#### **Headers and labels:**
...
### Translation Methods
Headers and labels, and User-Inputted Fields, can each be translated through different methods:
    ![translation methods](https://media.github.ibm.com/user/386696/files/8fd33817-150e-4cd9-8e6f-550571d63c89)

    Click [here](/Business%20Overview/Capabilities/Headers%20and%20Labels) for more information on where and how the capability of translating headers and labels can be addressed.

    Click [here](/Business%20Overview/Capabilities/User%20Inputted%20Fields) for more information on where and how the capability of translating headers and labels can be addressed.


#### <font color="#000080"> <b> Native Translation Service </b> </font>

#### <font color="#000080"> <b> Custom Translation Service </b> </font>

**Goal:** Replicate Watson Language Translator and/or NeuralSeek's translation behahavior by providing transient transaltions across all user-inputted fiels with the click of a button.
...
**How to implement:** Go [here](/Create/Translation%20Service)
#### <font color="#000080"> <b> Configuration Export Translation </b> </font>
