...
Headers and labels, and User-Inputted Fields, can each be translated through different methods:
    ...
    Click [here](/Business%20Overview/Use%20Cases/Translate%20Headers%20and%20Labels) for more information on where and how the capability of translating headers and labels can be addressed.

    Click [here](/Business%20Overview//Use%20Cases/Translate%20User%20Fields) for more information on where and how the capability of translating headers and labels can be addressed.
